...
SCENE_LIST="treehill flowers kitchen bicycle stump"
TRAJ_NAME="spiral"
...
# SCENE_LIST="multichromeball_identical_kitchen_v2 multichromeball_tint_kitchen_v2 multichromeball_value_kitchen_v2"
# TRAJ_NAME="spiral"
